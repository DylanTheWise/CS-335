	...
	IntBuffer indicesBuf = Buffers.newDirectIntBuffer(indices);
	 ...
	 public void displayChanged(GLAutoDrawable gLDrawable, 
		...
		public void keyTyped(KeyEvent e) {
			...
			if(key == 'f') { circleObject.moveRight(); }
			
			if(key == 'a') { circleObject.moveLeft(); }
			
			if(key == 'w') { circleObject.moveUp(); }
			
			if(key == 'z') { circleObject.moveDown(); }
			
			if(key == 'o') { circleObject.increaseRad(); }
			
			if(key == 'p') { circleObject.decreaseRad(); }
		}
